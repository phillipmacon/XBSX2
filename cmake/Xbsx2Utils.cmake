...
function(get_git_version_info)
	...
	elseif(XBSX2_GIT_REV)
		set(XBSX2_VERSION_LONG "${PCSX2_GIT_REV}")
		string(REGEX MATCH "[0-9]+\\.[0-9]+(\\.[0-9]+)?(-[a-z][a-z0-9]+)?" PCSX2_VERSION_SHORT "${PCSX2_VERSION_LONG}")
	else()
		set(XBSX2_VERSION_LONG "Unknown (git unavailable)")
		set(XBSX2_VERSION_SHORT "Unknown")
	endif()
	if ("${PCSX2_WC_TIME}" STREQUAL "")
		set(XBSX2_WC_TIME 0)
	endif()

	set(XBSX2_WC_TIME "${PCSX2_WC_TIME}" PARENT_SCOPE)
	set(XBSX2_GIT_REV "${PCSX2_GIT_REV}" PARENT_SCOPE)
	set(XBSX2_GIT_TAG "${PCSX2_GIT_TAG}" PARENT_SCOPE)
	set(XBSX2_GIT_HASH "${PCSX2_GIT_HASH}" PARENT_SCOPE)
	set(XBSX2_VERSION_LONG "${PCSX2_VERSION_LONG}" PARENT_SCOPE)
	set(XBSX2_VERSION_SHORT "${PCSX2_VERSION_SHORT}" PARENT_SCOPE)
endfunction()
