...
extern void* xbsx2_aligned_realloc(void* handle, size_t new_size, size_t align, size_t old_size);
extern void _aligned_free(void* pmem);
#else
#define xbsx2_aligned_realloc(handle, new_size, align, old_size) \
...
public:
	...
	{
		m_buffer.reset(reinterpret_cast<T*>(xbsx2_aligned_realloc(m_buffer.release(), newsize * sizeof(T), align, m_size * sizeof(T))));
		m_size = newsize;
