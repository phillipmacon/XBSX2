...
public:
	...
	void Open(std::string fullPath, const Xbsx2Config::McdOptions& mcdOptions, const u32 sizeInClusters, const bool enableFiltering, std::string filter, bool simulateFileWrites = false);
...
protected:
	...
	// "delete" (prepend '_xbsx2_deleted_' to) any files that exist in oldFileEntries but no longer exist in m_fileEntryDict
