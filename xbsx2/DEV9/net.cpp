...
NetAdapter* GetNetAdapter()
{
	...
	{
#ifdef _WIN32
		case Xbsx2Config::DEV9Options::NetApi::TAP:
			na = static_cast<NetAdapter*>(new TAPAdapter());
			break;
#endif
		case Xbsx2Config::DEV9Options::NetApi::PCAP_Bridged:
		case Xbsx2Config::DEV9Options::NetApi::PCAP_Switched:
			na = static_cast<NetAdapter*>(new PCAPAdapter());
			break;
		case Xbsx2Config::DEV9Options::NetApi::Sockets:
...
void ReconfigureLiveNet(const Xbsx2Config& old_config)
{
	//Eth
