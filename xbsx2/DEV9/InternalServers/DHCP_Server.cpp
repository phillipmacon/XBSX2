...
namespace InternalServers
{
...
#endif
	{
		...
		{
			case Xbsx2Config::DEV9Options::DnsMode::Manual:
				dns1 = *(IP_Address*)EmuConfig.DEV9.DNS1;
				break;
			case Xbsx2Config::DEV9Options::DnsMode::Internal:
				dns1 = {192, 0, 2, 1};
				break;
			default:
				break;
		...
		AutoDNS(adapter, EmuConfig.DEV9.ModeDNS1 != Xbsx2Config::DEV9Options::DnsMode::Manual, EmuConfig.DEV9.ModeDNS2 != Xbsx2Config::DEV9Options::DnsMode::Manual);
			...
			for (size_t i = 0; i < reqList.size(); i++)
			{
				switch (reqList[i])
				{
					...
					case 6:
						...
						break;
					case 15:
						retPay->options.push_back(new DHCPopDnsName("XBSX2"));
						break;
					case 28:
