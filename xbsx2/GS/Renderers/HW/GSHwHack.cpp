...
bool GSC_DeathByDegreesTekkenNinaWilliams(const GSFrameInfo& fi, int& skip)
{
	...
	// See https://forums.xbsx2.net/Thread-GSDX-Texture-Cache-Bug-Report-Death-By-Degrees-SLUS-20934-NTSC
	if (skip == 0)
	{
...
bool GSC_SteambotChronicles(const GSFrameInfo& fi, int& skip)
{
	if (skip == 0)
	{
		// Author: miseru99 on forums.xbsx2.net
...
void GSState::SetupCrcHack()
{
	...
	if (CRC_Full)
	{
		...
		// see https://github.com/XBSX2/xbsx2/pull/2921
