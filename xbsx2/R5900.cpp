...
__ri void cpuException(u32 code, u32 bd)
{
	...
	else
	{
		...
		Console.Error("*XBSX2* FIX ME: Level 2 cpuException");
...
static __fi void _cpuTestInterrupts()
{
	...
	/* These are 'xbsx2 interrupts', they handle asynchronous stuff
...
inline bool isBranchOrJump(u32 addr)
{
	...
	// Return false for eret & syscall as they are branch type in xbsx2 debugging tools,
