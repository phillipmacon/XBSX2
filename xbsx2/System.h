...
public:
	...
	bool HadSomeFailures( const Xbsx2Config::RecompilerOptions& recOpts ) const;
...
// GetCpuProviders - this function is not implemented by XBSX2 core -- it must be
...
namespace Msgbox
{
	extern bool	Alert( const wxString& text, const wxString& caption="XBSX2 Message", int icon=wxICON_EXCLAMATION );
	extern bool	OkCancel( const wxString& text, const wxString& caption="XBSX2 Message", int icon=0 );
	extern bool	YesNo( const wxString& text, const wxString& caption="XBSX2 Message", int icon=wxICON_QUESTION );
