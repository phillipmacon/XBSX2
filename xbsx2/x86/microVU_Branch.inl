...
void normBranch(mV, microFlagCycles& mFC)
{
	...
	{
		if (mVUlow.badBranch)
			DevCon.Warning("End on evil Unconditional branch! - Not implemented! - If game broken report to XBSX2 Team");
...
void condBranch(mV, microFlagCycles& mFC, int JMPcc)
{
	...
	if (mVUup.eBit) // Conditional Branch With E-Bit Set
	{
		if (mVUlow.evilBranch)
			DevCon.Warning("End on evil branch! - Not implemented! - If game broken report to XBSX2 Team");
