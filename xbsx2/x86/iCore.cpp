...
int _getFreeXMMreg()
{
	...
	pxFailDev("*XBSX2*: XMM Reg Allocation Error in _getFreeXMMreg()!");
...
int _allocTempXMMreg(XMMSSEType type, int xmmreg)
{
	...
	if (xmmreg == -1)
	{
		pxFailDev("*XBSX2*: XMM Reg Allocation Error in _allocTempXMMreg()!");
		throw Exception::FailedToAllocateRegister();
	}
	else
	{
...
int _allocFPtoXMMreg(int xmmreg, int fpreg, int mode)
{
	...
	if (xmmreg == -1)
	{
		pxFailDev("*XBSX2*: XMM Reg Allocation Error in _allocFPtoXMMreg()!");
		throw Exception::FailedToAllocateRegister();
	}
	else
	{
...
int _allocGPRtoXMMreg(int xmmreg, int gprreg, int mode)
{
	...
	if (xmmreg == -1)
		...
		if (xmmreg == -1)
	{
		pxFailDev("*XBSX2*: XMM Reg Allocation Error in _allocGPRtoXMMreg()!");
		throw Exception::FailedToAllocateRegister();
	}
	else
	{
...
int _allocFPACCtoXMMreg(int xmmreg, int mode)
{
	...
	if (xmmreg == -1)
		...
		if (xmmreg == -1)
	{
		pxFailDev("*XBSX2*: XMM Reg Allocation Error in _allocFPACCtoXMMreg()!");
		throw Exception::FailedToAllocateRegister();
	}
	else
	{
