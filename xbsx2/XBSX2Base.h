...
/// Base defines and typedefs that are needed by all code in XBSX2
/// Prefer this over including Xbsx2Defs.h to make sure everyone gets all the defines, as missing defines fail silently
...
#include "GS/config.h"
	...
	// Convert gcc see define into GS (windows) define
		...
		#define _M_SSE 0x401
	#else
		#error XBSX2 requires compiling for at least SSE 4.1
	#endif
#elif _M_SSE < 0x401
	#error XBSX2 requires compiling for at least SSE 4.1
#endif
