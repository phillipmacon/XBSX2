...
// "patch" in xbsx2 terminology is a single pnach style patch line, e.g. patch=1,EE,001110e0,word,00000000
...
// In XBSX2 it indicates how/when/where the patch line should be applied. If
// place is not one of the supported values then the patch line is never applied.
// XBSX2 currently supports the following values:
...
// The following prototypes seem unused in XBSX2, but maybe part of the cheats browser?
