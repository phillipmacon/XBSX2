...
public:
	...
	// this hooks into xbsx2's main App event handler as it has to be able to resume emulation
	...
	// Resume emulation when the next xbsx2 App event is handled
	void Resume();
	/**
...
private:
	...
	// Indicates if we intend to call CoreThread.Resume() when the next xbsx2 App event is handled
