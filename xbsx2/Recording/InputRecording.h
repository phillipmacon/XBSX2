...
public:
	...
	// Save or load XBSX2's global frame counter (g_FrameCount) along with each full/fast boot
	//
	...
	// The internal XBSX2 g_FrameCount value on the first frame of the recording
...
private:
	...
	// See - PAD.cpp::PADpoll - https://github.com/XBSX2/xbsx2/blob/master/xbsx2/PAD/Windows/PAD.cpp#L1255
	...
	// See - PAD.cpp::PADpoll - https://github.com/XBSX2/xbsx2/blob/master/xbsx2/PAD/Windows/PAD.cpp#L1256
