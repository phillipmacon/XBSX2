...
#define GZIP_ID "XBSX2.index.gzip.v1|"
...
static void TestTemplate(const wxDirName &base, const wxString &fname, bool canEndWithKey)
{
	const char *ins[] = {
		...
		"%appdata%/xbsx2/cache/$(f).pindex",  // c:/Users/<user>/AppData/Roaming/xbsx2/cache/ ...
		"c:\\xbsx2-cache/$(f).pindex",        // absolute
...
{
#ifndef XBSX2_CORE
	std::string appRoot = // TODO: have only one of this in XBSX2. Right now have few...
