...
// indicating that XBSX2 is running in NoGUI mode, or that the main frame has been
...
// NULL (typically indicating that XBSX2 is running in NoGUI mode, or that the main
