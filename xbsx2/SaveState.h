...
public:
	...
	// The version refers to the low 16 bits only (high 16 bits classifies Xbsx2 build types)
...
protected:
	...
	// Save or load XBSX2's global frame counter (g_FrameCount) along with each savestate
	//
